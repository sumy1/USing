...
public class ScaleAdapter extends RecyclerView.Adapter<ScaleAdapter.myViewHolder>{
    ...
    public ScaleAdapter(Context context, ArrayList<HashMap<String,Object>> data,OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder myViewHolder, int pos) {
        ...
        myViewHolder.itemView.setOnClickListener(v -> {
            setDataUpdate(pos);
            listener.onScaleClick(pos,(String)model.get(kName));
        });
    }
    ...
    public interface OnItemClickListener{
        void onScaleClick(int pos, String name);
    }
}
